            ...
            <div class="car-images-and-description">
              ...
              <div class="card car-detailed-description">
                ...
                <ul class="car-specifications">
                  <x-car-specification :spec="$car->features->abs">
                    ABS
                  </x-car-specification>
                  <x-car-specification :spec="$car->features->air_conditioning">
                    Air Conditioning
                  </x-car-specification>
                  <x-car-specification :spec="$car->features->power_windows">
                    Power Windows
                  </x-car-specification>
                  <x-car-specification :spec="$car->features->power_door_locks">
                    Power Door Locks
                  </x-car-specification>
                  <x-car-specification :spec="$car->features->cruise_control">
                    Cruise Control
                  </x-car-specification>
                  <x-car-specification :spec="$car->features->bluetooth_connectivity">
                    Bluetooth Connectivity
                  </x-car-specification>
                  <x-car-specification :spec="$car->features->remote_start">
                    Remote Start
                  </x-car-specification>
                  <x-car-specification :spec="$car->features->gps_navigation">
                    GPS Navigation
                  </x-car-specification>
                  <x-car-specification :spec="$car->features->heated_seats">
                    Heated Seats
                  </x-car-specification>
                  <x-car-specification :spec="$car->features->climate_control">
                    Climate Control
                  </x-car-specification>
                  <x-car-specification :spec="$car->features->rare_parking_sensors">
                    Rare Parking Sensors
                  </x-car-specification>
                  <x-car-specification :spec="$car->features->leather_seats">
                    Leather Seats
                  </x-car-specification>
                </ul>
              </div>
